(function () {
    ...
    class SelectWireframeImage extends QuillModule {
        constructor(quill) {
            ...
            this.imgFlag = null;  //wireframe 框架图 mindmap 思维导图  general 普通图片  imgModal 选择图片弹框
            this.filter = [];
            ...
            if (typeof this.toolbar != 'undefined') {
                ...
                this.toolbar.addHandler('image-model-btn', this.imageModalHanlder.bind(this));
            }
        ...
        init() {
            ...
            let IamgeModals = `    
            <div class="curent-modal images-modal">
                <div class="curent-modal-bg"></div>
                <div class="curent-modal-box">
                    <div class="box-top">
                        插入图片
                    ...
                    <div class="box-center">
                        <div class="item-list item-list-type">
                            <div class="item-list-label">
                                图片类型：
                            </div>
                            <div class="item-list-center">
                                <span data-type="single" class="radio-span active"><span></span>单图</span>
                                <span data-type="multple" class="radio-span"><span></span>多图</span>
                            </div>
                        </div>

                        <div class="item-list item-list-single">
                            <div class="item-list-label">
                                图片备注：
                            </div>
                            <div class="item-list-center">
                                <input maxlength="50" class="item-input item-input-describe" type="text" placeholder="请输入图片备注，选填">
                            </div>
                        </div>
                        <div class="item-list item-list-multple" style="display: none">
                            <div class="item-list-label">
                                图片备注：
                            </div>
                            <div class="item-list-center">
                        ...
                        <div class="item-list item-list-single">
                            ...
                            <div class="item-list-center">
                                <div class="item-list-center-single">
                                    <label class="item-upload-box">
                                        <input class="item-upload-input" type="file" accept="image/*">
                                        <div class="current-img-box">
                                            <img class="current-img current-img-single" src="" alt="">
                                        </div>
                                        <div class="item-def">
                                            <img src="/static/new-report/img/pic-add-icon.png" alt="">
                                            <div class="item-def-text">上传图片</div>
                                        </div>
                                    </label> 
                                </div>
                                <div class="text">建议尺寸：16:9</div>
                            </div>
                        </div>
                        <div class="item-list item-list-multple" style="display: none">
                            <div class="item-list-label">
                            ...
                            <div class="item-list-center">
                                <div class="item-list-center-multiple">
                                    <label class="item-upload-box item-upload-box-multiple">
                                        <input class="item-upload-input" type="file" accept="image/*">
                                        <div class="current-img-box">
                                            <img class="current-img current-img-multiple" src="" alt="">
                                            <span class="del-item">
                                                <svg width="20" height="20" fill="currentColor">
                                                    <path d="M14,6 L6,6 L6,16 L14,16 L14,6 Z M16,6 L16,16 L16,18 L4,18 L4,16 L4,6 L2,6 L2,4 L18,4 L18,6 L16,6 Z M8,8 L9,8 L9,14 L8,14 L8,8 Z M11,8 L12,8 L12,14 L11,14 L11,8 Z M7,1 L13,1 L13,3 L7,3 L7,1 Z"></path>
                                                </svg>
                                            </span>
                                        </div>
                                        <div class="item-def">
            ...
            `;
            $('body').append(IamgeModals);

            var sort = Sortable.create($('.item-list-center-multiple')[0], {
                swapThreshold: 1,
                animation: 150,
            });
        }
        ...
        initTipDom() {
            ...
            <div class="img-tip clearfix">
                ...
                <div class="img-tip-type img-tip-single-img">
                    <div class="img-tip-item tip-again-uploading">
                        <div class="img-tip-icon">
                            <svg width="20" height="20" fill="currentColor">
                                <path d="M10,19 C5.02943725,19 1,14.9705627 1,10 C1,5.02943725 5.02943725,1 10,1 C14.9705627,1 19,5.02943725 19,10 C19,14.9705627 14.9705627,19 10,19 Z M10,17 C13.8659932,17 17,13.8659932 17,10 C17,6.13400675 13.8659932,3 10,3 C6.13400675,3 3,6.13400675 3,10 C3,13.8659932 6.13400675,17 10,17 Z M11,10 L11,14 L9,14 L9,10 L6,10 L10,6 L14,10 L11,10 Z"/>
                ...
                <div class="img-tip-type img-tip-multiple-img">
                    <div class="img-tip-item tip-again-uploading">
                        <div class="img-tip-icon">
                            <svg width="20" height="20" fill="currentColor">
                                <path d="M10,19 C5.02943725,19 1,14.9705627 1,10 C1,5.02943725 5.02943725,1 10,1 C14.9705627,1 19,5.02943725 19,10 C19,14.9705627 14.9705627,19 10,19 Z M10,17 C13.8659932,17 17,13.8659932 17,10 C17,6.13400675 13.8659932,3 10,3 C6.13400675,3 3,6.13400675 3,10 C3,13.8659932 6.13400675,17 10,17 Z M11,10 L11,14 L9,14 L9,10 L6,10 L10,6 L14,10 L11,10 Z"/>
        ...
        initShortcut() {
            ...
            <div class="shortcut-div-modal">
                ...
                <div class="shortcut-div-list" btn-class="ql-image-model-btn">
                    <svg width="20" height="20" fill="currentColor">
        ...
        initHandle() {
            ...
            $('.curent-modal-bg,.btn-off,.box-top-close').click(() => {
                if (
                    ...
                    var index = that.quillIndex.index;
            ...
            $('.btn-comfim').click(() => {
                ...
                if (this.imgFlag == 'imgModal') {
                    let type = $('.radio-span.active').attr('data-type');
                    if(type == 'single'){
                        this.insertSingleQuill();

                    }else{
                        this.insertMultipleQuill()
                    }
                }
            ...
            // 图片类型
            $('.radio-span').click(function(e){

                $(this).addClass('active');
                $(this).siblings().removeClass('active');

                if($(this).attr('data-type') == 'single'){
                    $('.item-list-single').show()
                    $('.item-list-multple').hide()
                }else{
                    $('.item-list-single').hide()
                    $('.item-list-multple').show()
                    $('.item-list-multple .current-img-box').hide();
                }

            })
            // 选择图片
            $('.item-upload-input').change(function(e){
                let file = e.target.files[0]
                let formData = new FormData();
                formData.append('file', file);
                that.updateImg(formData,(data)=>{
                    $(this).siblings('.current-img-box').show();
                    $(this).siblings('.current-img-box').find('.current-img').attr({
                        'src':data.file_url,
                        'id':data.id,
                        'uid':data.uid
                    })
                    $(this).siblings('.item-def').hide()
                });
            ...
            $('.del-item').click(function(e){
                e.stopPropagation();
                e.preventDefault();
                $(this).siblings('.current-img').attr({
                    'src':'',
                    'id':'',
                    'uid': '',
                })
                $(this).parent('.current-img-box').hide();
                $(this).parent().siblings('.item-def').show()
            })

            //多图轮播的左右切换
            $('#main-sections').on('click', '.swiper-button-prev-g', function(e) {
                e.stopPropagation();
                let el = $(this).siblings('.multiple-image-box');
                let listEl = $(this).siblings('.swiper-pagination').children('.swiper-pagination-bullet ');
                let width = el.width();
                let index = Number(el.attr('index')) || 0;
                if(index>0){
                    index -= 1;
                }else{
                    index = el.children('.item-box').length - 1
                }
                let transformX = 'translateX(-'+(index*width)+'px)';
                el.attr('index',index)
                el.css('transform',transformX)
                listEl.eq(index).addClass('active').siblings().removeClass('active')
            })
            $('#main-sections').on('click', '.swiper-button-next-g', function(e) {
                e.stopPropagation();
                let el = $(this).siblings('.multiple-image-box');
                let listEl = $(this).siblings('.swiper-pagination').children('.swiper-pagination-bullet ');
                let width = el.width();
                let index = Number(el.attr('index')) || 0;
                if(index<el.children('.item-box').length-1){
                    index += 1;
                }else{
                    index = 0
                }
            ...
            //tab切换
            $('.frame-modal .box-top-tab').click(function(e){
                let index = $(this).index();
                $(this).addClass('active').siblings().removeClass('active');
                $('.frame-modal .tab-box').eq(index).show().siblings().hide()
            })
            //选择过滤
            $('.filter-list').on('click', '.filter-item', function(e) {

                let val = $(this).attr('flag');
                if (val == '不限') {
                    that.filter = [];
                } else {
                    if (that.filter.indexOf(val) >= 0) {
                        for (let i = 0; i < that.filter.length; i++) {
                            if (that.filter[i] == val || that.filter[i] == 1) {
                ...
                if (that.filter.length <= 0) {
                    ...
                    $('.filter-item').map((index, item) => {
                        if (that.filter.indexOf($(item).attr('flag')) >= 0) {
            ...
            //选择框架图
            $('.center-div').on('click', '.center-div-item img', function (e){
                if ($('.gear-all-image.active').length > 0) {
                    $('.gear-all-image.active').attr('src', $(this).attr('src'));
                } else {
                    that.quill.insertEmbed(that.quillIndex.index, 'gear-image', {
            ...
            // 普通上传
            // 三个重新上传按钮
            $('.btn-upimg-frame,.btn-upimg-mindmap,.btn-upimg-general,.btn-upimg-reset').click( function (){
                const input = document.createElement('input');
                input.setAttribute('type', 'file');

                if (that.imgFlag == 'mindmap') {
                ...
                input.onchange = () => {
                    ...
                    if (that.imgFlag == 'wireframe') {
                        let url = "/api/reports/frame_diagrams/upload";
                        that.updateFrameImg(url, formData);
                    } else if (that.imgFlag == 'mindmap') {
                        let url = "/api/reports/mind_maps/upload";
                        that.updateMindmapImg(url, formData);
                    } else {
                        let url = "/api/reports/files/upload";
                        that.updateGeneralImg(url, formData);
                    }
            ...
            //插入后的图点击
            $('#main-sections').on('click', '.gear-all-image', function(e){
                that.imgFlag = $(this).attr('flag');

                that.quill.blur();

                $('.img-tip').show();
                if ($(this).attr('flag') == 'wireframe') {
                    $('.img-tip-type.img-tip-type-frame').show().siblings('.img-tip-type').hide();
                } else if ($(this).attr('flag') == 'mindmap') {
                    $('.img-tip-type.img-tip-type-mindmap').show().siblings('.img-tip-type').hide();
                } else if($(this).hasClass('gear-single-image')){
                    $('.img-tip-type.img-tip-single-img').show().siblings('.img-tip-type').hide();
                } else if($(this).hasClass('gear-multiple-image')){
                    $('.img-tip-type.img-tip-multiple-img').show().siblings('.img-tip-type').hide();
                } else {
                ...
                let topNum = $(this).offset().top - document.documentElement.scrollTop;
                let leftNum = $(this).offset().left + $(this).width() / 2;
                let parentTopNum = $(this).position().top;
                let parentLeftNum = $(this).position().left;
            ...
            //重新上传 -- 单图
            $('#main-sections').on('click', '.img-tip-single-img .tip-again-uploading', function (e) {
                that.imageModalHanlder();
                $('.item-list-type').hide()
                ...
                $('[data-type="single"]').addClass('active');
                $('.item-list-single').show()
                $('.item-list-multple').hide()
                $('.item-list-single .item-input-describe').val('')
                $('.item-upload-input').val('')
                $('.current-img').attr('src','')
                $('.current-img').attr('id','')
                $('.current-img').attr('uid','')
                $('.item-def').show()

                let currentDom = $('.gear-single-image.active')
                let describe = $('.gear-single-image.active').find('.img-describe').html()
                let imgDom = $('.gear-single-image.active').find('.img-pic')
                $('.item-input-describe').val(describe);
                $('.current-img-single').attr({
                    src: imgDom.attr('src'),
                    id: currentDom.attr('id'),
                    uid: currentDom.attr('uid')
                })
                $('.current-img-single').parent('.current-img-box').show()
                $('.current-img-single').parent().siblings('.item-def').hide();

            })
            //重新上传 -- 多图
            $('#main-sections').on('click', '.img-tip-multiple-img .tip-again-uploading', function (e) {
                that.imageModalHanlder();
                $('.item-list-type').hide()
                ...
                $('.radio-span').removeClass('active');
                $('[data-type="multple"]').addClass('active');
                $('.item-list-single').hide()
                $('.item-list-multple').show()


                let describe = $('.gear-multiple-image.active').find('.img-describe').html()
                let id = $('.gear-multiple-image.active').id
                let uid = $('.gear-multiple-image.active').uid
                let datas = [];

                $('.gear-multiple-image.active').find('.item-img').each(function(){
                    if( $(this).attr('src') ){
                        datas.push({
                            src: $(this).attr('src'),
                            uid: $(this).attr('uid'),
                ...
                $('.item-list-multple .item-input-describe').val(describe)
                $('.item-upload-box-multiple .current-img-multiple').each(function(i){
                    if(datas[i] && datas[i].src){
                        $(this).parent('.current-img-box').show()
                        $(this).attr({
                            src: datas[i].src,
                            uid: datas[i].uid,
                            id: datas[i].id,
                        })
                        $(this).parent().siblings('.item-def').hide();
                    }
                })
            })
            ...
            //删除
            $('#main-sections').on('click', '.tip-del-inline', function(e) {
                let line = Quill.find($('.gear-all-image.active')[0])
                let index = that.quill.getIndex(line);
                that.quill.deleteText(index, 1);
        ...
        insertSingleQuill(){
            let data = {
                src: $('.current-img-single').attr('src') || '',
                uid: $('.current-img-single').attr('uid') || '',
                id: $('.current-img-single').attr('id') || '',
                describe: $('.item-list-single .item-input-describe').val()
            }
            ...
            if($('.gear-single-image.active').length>0){
                $('.gear-single-image.active').find('.img-pic').attr('src', data.src );
                $('.gear-single-image.active').find('.img-describe').html( data.describe );
            }else{
                this.quill.insertEmbed(this.quillIndex.index, 'GearSingleImage', data);
            }
        ...
        insertMultipleQuill(){
            let multipledata = [];
            $('.current-img-multiple').each(function(){
                if( $(this).attr('src') ){
                    multipledata.push({
                        src: $(this).attr('src'),
                        uid: $(this).attr('uid'),
            ...
            let data = {
                ...
                uid: getUUID(),
                id: getUUID(),
                describe: $('.item-list-multple .item-input-describe').val()
            }
            ...
            //编辑
            if($('.gear-multiple-image.active').length>0){
                $('.gear-multiple-image.active').find('.img-describe').html( data.describe );

                let doms = '';
                let pageDom = '';
                multipledata.forEach((item,i)=>{
                    doms += `<div class="swiper-slide item-box" data-tag-flag="gear-custom-module">
                            <div class="swiper-slide-div" data-tag-flag='gear-custom-module'>
                                <div class="more-pic-box" data-tag-flag='gear-custom-module'>
                                    <img class="item-img" src="${multipledata[i].src}" data-tag-flag="gear-custom-module" id="${multipledata[i].id}">
                                </div>
                            </div>
                        </div>`
                    pageDom += `<span data-tag-flag="gear-custom-module" class="swiper-pagination-bullet ${i==0?'active':''}"></span>`
                })

                $('.gear-multiple-image.active .swiper-container .multiple-image-box').html(doms)
                $('.gear-multiple-image.active .swiper-container .swiper-pagination').html(pageDom)


                $('.gear-multiple-image.active').find('.multiple-image-box').attr(index,0)
                $('.gear-multiple-image.active').find('.multiple-image-box').css('transform','translateX(0px)')

            }else{
                this.quill.insertEmbed(this.quillIndex.index, 'GearMultipleImage', data);
            }
